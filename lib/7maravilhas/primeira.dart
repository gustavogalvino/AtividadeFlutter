...
class Strings {
  ...
  static final secondText = "Fortificação feita para proteger";
  static final thirdText =  "o Império Chinês de invasões.";
  static final fourthText = "Foi construída entre os anos";
