...
class _SecondPageViewState extends State<SecondPageView>
  ...
  final image = AssetImage('imagens/petra.png');
...
class Strings {
  static final firstText =  "Petra";
  static final secondText = "Cidade histórica no sul da";
  static final thirdText =  "Jordânia, caracterizada pela";
  static final fourthText = "arquitetura esculpida em rocha";
}